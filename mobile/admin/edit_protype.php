...
<body>
    <?php
        ...
        if(isset($_GET['type_id']))
        {
            ...
            $typedarr = $protype->getAllProtypeById($type_id);
            $type_name = $typedarr['type_name'];            
        } 
    ?>
    <!--Header-part-->
    <div id="header">
                        ...
                        <div class="widget-content nopadding">
                            ...
                            <form action="check/check_edit.php" method="post" class="form-horizontal"
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span11" placeholder="Protype name" name="type_name" value="<?php echo $type_name ?>" required /> *
                                    </div>
                                </div>                                
