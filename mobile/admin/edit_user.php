...
<body>
    <?php
        ...
        if(isset($_GET['user_id']))
        {
            ...
            $userarr = $user->getUserById($user_id);
            $user_name = $userarr['user_name'];       
            $role = $userarr['role'];     
        } 
    ?>
    <!--Header-part-->
                        ...
                        <div class="widget-content nopadding">
                            ...
                            <form action="check/check_edit.php" method="post" class="form-horizontal"
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span11" placeholder="User name" name="user_name" value="<?php echo $user_name ?>" required /> *
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">Role :</label>
                                    <div class="controls">
                                        <input type="text" class="span11" placeholder="role" name="role" value="<?php echo $role ?>" required /> *
                                    </div>
                                </div>                                
