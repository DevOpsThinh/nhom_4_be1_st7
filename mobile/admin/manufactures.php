                                ...
                                <tbody>
                                    ...
                                    ?>           
                                        <tr class="">
                                            ...
                                            <td>
                                                <a href="edit_manufacture.php?manu_id=<?php echo $key['manu_id'] ?>" class="btn btn-success btn-mini">Edit</a>
                                                <a href="delpro.php?manu_id=<?php echo $key['manu_id'] ?>" class="btn btn-danger btn-mini">Delete</a>
                                            </td>
                                        </tr>                               
                                    <?php } ?>
                                </tbody>
