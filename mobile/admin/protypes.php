            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="widget-box">
                        <div class="widget-title"> <span class="icon"><a href="form/typeform.php"> <i class="icon-plus"></i>
                                </a></span>
                            <h5>Protypes</h5>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    ?>           
                                        <tr class="">
                                            ...
                                            <td>
                                                <a href="edit_protype.php?type_id=<?php echo $key['type_id'] ?>" class="btn btn-success btn-mini">Edit</a>
                                                <a href="delpro.php?type_id=<?php echo $key['type_id'] ?>" class="btn btn-danger btn-mini">Delete</a>
                                            </td>
                                        </tr>                               
                                    <?php } ?>                                
                                </tbody>
