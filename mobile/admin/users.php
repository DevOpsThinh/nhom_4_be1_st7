                                ...
                                ?>
                                    ...
                                    <tbody>
                                        <tr class="">
                                            ...
                                            <td><?php echo str_ireplace($key['password'],"***********",$key['password'])?></td>
                                            <td><?php echo $key['role'] ?></td>
                                            <td>
                                                <a href="edit_user.php?user_id=<?php echo $key['user_id'] ?>" class="btn btn-success btn-mini">Edit</a>
                                                <a href="delpro.php?user_id=<?php echo $key['user_id'] ?>" class="btn btn-danger btn-mini">Delete</a>
                                            </td>
                                        </tr>                                    
                                    </tbody> 
                                <?php } ?>
